...
//handling fixed header
var site_content = document.querySelector('.site-content');
var header = document.querySelector('header');

function handleFixedHeader(){
  if(!site_content || !header) return;
  site_content.style.marginTop = getComputedStyle(header,null).height;
}
...
//owl carousel 1
$(document).ready(function(){
  if(document.querySelector(".owl-carousel-single")) $(".owl-carousel-single").owlCarousel({
      nav:false,
      // navContainer: '.custom-owl-nav-single',
      // navText: [document.querySelector('.owl-prev-template-single'),document.querySelector('.owl-next-template-single')],
      rtl: false,
      loop:true,
