  ...
  <div class="card-body px-0 pt-0">
    ...
    <div class="row mx-0">
      ...
      <div class="col-12 px-0 form-group">
        ...
        {!! Form::textarea('content_en', null, ['id' => 'redactor_en'.$id, 'class' => 'form-control','rows'=>'3','cols'=>'80']) !!}
      </div>

      <div class="col-12 px-0 form-group">
        {!! Form::label('content_sw', 'Content in Swahili') !!}
        {!! Form::textarea('content_sw', null, ['id' => 'redactor_sw'.$id, 'class' => 'form-control','rows'=>'3','cols'=>'80']) !!}
      </div>
